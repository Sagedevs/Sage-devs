...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-black via-blue-950/20 to-black border-t border-blue-500/20 overflow-hidden z-0">
      {/* Simplified background elements */}
      <div className="absolute inset-0 pointer-events-none">
        {/* Static gradient orbs */}
        <div className="absolute top-5 left-5 sm:top-10 sm:left-10 w-48 h-48 sm:w-64 sm:h-64 lg:w-96 lg:h-96 bg-blue-600/10 rounded-full blur-3xl" />
        ...
        {/* Grid pattern */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(59,130,246,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(59,130,246,0.03)_1px,transparent_1px)] bg-[size:25px_25px] sm:bg-[size:40px_40px] lg:bg-[size:50px_50px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-5 text-center lg:text-left">
              <Link href="/" className="inline-block mb-6 lg:mb-8">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full blur-xl opacity-20" />
                  <Image
              ...
              <h2 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-white via-blue-200 to-cyan-200 bg-clip-text text-transparent mb-3 lg:mb-4">
                Sage devs
              </h2>
                ...
                {socialLinks.map((link) => (
                  ...
                  >
                    ...
                    <Image
                      ...
                      width={20}
                      height={20}
                      className="sm:w-[24px] sm:h-[24px] relative z-10 filter brightness-0 invert transition-opacity duration-300"
                    />
                  </Link>
                ))}
              </div>
            ...
            <div className="sm:col-span-2 lg:col-span-2 text-center lg:text-left sm:mx-auto lg:mx-0">
              <h3 className="text-white font-bold text-lg sm:text-xl mb-6 lg:mb-8 relative">
                ...
                <div className="absolute bottom-0 left-1/2 lg:left-0 transform -translate-x-1/2 lg:translate-x-0 h-0.5 w-12 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full" />
              </h3>
                  ...
                  <li key={link.href}>
                    ...
                    >
                      ...
                      <span className="relative text-sm sm:text-base">
                        {link.label}
                        <div className="absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full w-0 group-hover:w-full transition-all duration-300" />
                      </span>
                    </Link>
                  </li>
                ))}
            ...
            <div className="sm:col-span-2 lg:col-span-5">
              <h3 className="text-white font-bold text-lg sm:text-xl mb-6 lg:mb-8 relative text-center lg:text-left">
                ...
                <div className="absolute bottom-0 left-1/2 lg:left-0 transform -translate-x-1/2 lg:translate-x-0 h-0.5 w-12 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full" />
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {services.map((service) => (
                  <div
                    key={service.name}
                    className="group relative p-3 sm:p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-blue-400/50 transition-all duration-300 cursor-pointer hover:scale-105"
                  >
                    ...
                    <div className="relative z-10 flex items-start space-x-2 sm:space-x-3">
                      ...
                      <div>
                        <h4 className="text-white font-medium text-xs sm:text-sm mb-1 group-hover:text-blue-200 transition-colors duration-300">
                          {service.name}
                        </h4>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          variants={fadeInUp}
          className="py-8 sm:py-10 lg:py-12 border-t border-gradient-to-r from-transparent via-blue-500/20 to-transparent"
        >
          <div className="text-center mb-6 sm:mb-8">
            <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-400 via-white to-cyan-400 bg-clip-text text-transparent mb-2">
              Let&apos;s Connect
            </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {contactInfo.map((info) => (
              <Link
                key={info.label}
                href={info.href}
                className="group block p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-white/5 to-white/10 border border-white/10 backdrop-blur-sm hover:bg-gradient-to-br hover:from-blue-500/10 hover:to-cyan-500/10 hover:border-blue-400/50 transition-all duration-300 text-center hover:scale-105"
              >
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4 inline-block transition-transform duration-300 group-hover:scale-110">
                  {info.icon}
                </div>
                <p className="text-blue-300 text-xs sm:text-sm font-medium mb-2 group-hover:text-blue-200">
                  {info.label}
                </p>
                <p className="text-white font-semibold text-sm sm:text-base group-hover:text-blue-100 transition-colors duration-300 break-words">
                  {info.value}
                </p>
              </Link>
            ))}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          variants={fadeInUp}
          className="py-6 sm:py-8 border-t border-gradient-to-r from-transparent via-blue-500/20 to-transparent"
        >
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 lg:space-x-8 text-xs sm:text-sm">
              <Link
                href="/privacy"
                className="text-gray-400 hover:text-blue-300 transition-colors duration-300 relative group"
              >
                Privacy Policy
                <div className="absolute bottom-0 left-0 h-0.5 bg-blue-400 rounded-full w-0 group-hover:w-full transition-all duration-300" />
              </Link>
              <Link
                href="/terms"
