...
const caseStudies: CaseStudy[] = [
  {
    ...
    challenge:
      "Creating a comprehensive, trustworthy platform for business insurance services with complex policy options, client testimonials, and seamless quote generation system.",
    solution:
      "Developed a professional website with detailed service pages, client success stories, comprehensive FAQ section, testimonials, and integrated contact forms for quick quotes.",
    results: [
  ...
  },
  {
    ...
    challenge:
      "Building an appetizing digital presence for a Pakistani restaurant with online reservations, detailed menu showcase, cultural authenticity, and franchise opportunities.",
    solution:
      "Created a vibrant, culturally-rich website with high-quality food photography, comprehensive menu with prices, reservation system, franchise information, and Instagram integration.",
    results: [
  ...
  },
  {
    ...
    challenge:
      "Creating a standout developer portfolio showcasing full-stack expertise, modern technologies, project case studies, and comprehensive service offerings.",
    solution:
      "Built a modern, interactive portfolio with advanced animations, detailed project showcases, comprehensive tech stack display, client testimonials, and FAQ section.",
    results: [
